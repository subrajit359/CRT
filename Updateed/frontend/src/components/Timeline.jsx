...
const KIND_META = {
  case_verified:    { dot: "var(--green-700)",  icon: "✓" },
  case_unverified:  { dot: "var(--rose-700)",   icon: "!" },
  discussion_reply: { dot: "var(--primary)",    icon: "💬" },
  delete_request:   { dot: "var(--amber-700)",  icon: "⚠" },
  delete_decision:  { dot: "var(--ink-700)",    icon: "·" },
  doctor_pending:   { dot: "var(--amber-700)",  icon: "⏳" },
  doctor_approved:  { dot: "var(--green-700)",  icon: "✓" },
  doctor_rejected:  { dot: "var(--rose-700)",   icon: "✕" },
  welcome:          { dot: "var(--primary)",    icon: "★" },
  "attempt-high":   { dot: "var(--green-700)",  icon: "↑" },
  "attempt-low":    { dot: "var(--rose-700)",   icon: "↓" },
  attempt:          { dot: "var(--primary)",    icon: "·" },
};
