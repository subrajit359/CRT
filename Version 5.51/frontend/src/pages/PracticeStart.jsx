      ...
      <div className="container fade-in" style={{ maxWidth: 920 }}>
        ...
        <div className="card">
          ...
          <button
            ...
            style={{ justifyContent: "center", gap: 8, alignItems: "center" }}
            disabled={busy}
            onClick={startRandom}
          >
  ...
  return (
    <button type="button" className={cardClass} onClick={onOpen}>
      ...
      <div className="group-meta">
        <span className={`group-status ${statusClass} row`} style={{ gap: 4, alignItems: "center", display: "inline-flex" }}>
          {isCompleted && <CheckCircle2 size={12} strokeWidth={1.75} aria-hidden="true" />}
          {statusLabel}
        </span>
