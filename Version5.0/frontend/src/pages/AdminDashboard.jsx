...
import {
  ...
  MessageSquare, User as UserIcon, ChevronRight, UserX, BookOpen, Mail,
} from "lucide-react";
      ...
      <div className="container fade-in">
        ...
        >
          ...
          <NavCard
            ...
            title="All users"
            body="Manage student and doctor accounts"
          />
          <NavCard
            href="/admin/account-delete-requests"
            icon={<UserX size={20} strokeWidth={1.75} aria-hidden="true" />}
            title="Account deletion requests"
            body="Review requests from users to delete their accounts"
          />
          <NavCard
            href="/admin/cases"
            icon={<BookOpen size={20} strokeWidth={1.75} aria-hidden="true" />}
            title="Manage cases"
            body="Edit any case's details or attachments"
          />
          <NavCard
            href="/admin/mail"
            icon={<Mail size={20} strokeWidth={1.75} aria-hidden="true" />}
            title="Mail sender"
            body="Send an email directly to any registered user"
          />
        </div>

        {/* Practice activity — by user */}
        <div className="spacer-7" />
        <div className="card">
